...
def predict():
    ...
    # Read and process the image directly from request
    imagefile = request.files['imagefile']
    image = load_img(imagefile, target_size=(256, 256))
    image = tf.image.rgb_to_grayscale(img_to_array(image))
    ...
    # Classify the result
    classification = "Normal" if yhat > 0.5 else "An Anomaly"
